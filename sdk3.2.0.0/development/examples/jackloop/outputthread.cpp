...
OutputThread::OutputThread() : AbstractThread( SV_JACK_CHANNEL_OUT, SV_OPENTYPE_OUTPUT, "OUTPUT" )
{
}
...
void OutputThread::run()
{
  ...
  //Now I am finished
  mRunning = 0;
  dvs_cond_broadcast( &mWaitConditionFinish, &mMutexRunning, 0 );
}
