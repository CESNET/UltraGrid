...
char * sv_support_videomode2string(int videomode)
{
  ...
  case SV_MODE_FILM2K_1080_23sF:    mode = "FILM2K_1080/23sF";    break;
  case SV_MODE_FILM2K_1080_24sF:    mode = "FILM2K_1080/24sF";    break;
  case SV_MODE_FILM2K_1080_23P:     mode = "FILM2K_1080/23P";     break;
  case SV_MODE_FILM2K_1080_24P:     mode = "FILM2K_1080/24P";     break;

  case SV_MODE_FILM2K_1536_24P:     mode = "FILM2K_1536/24P";     break;
  case SV_MODE_FILM2K_1536_48P:     mode = "FILM2K_1536/48P";     break;
  case SV_MODE_FILM2K_1536_24sF:    mode = "FILM2K_1536/24sF";    break;

  case SV_MODE_FILM2K_1556_14sF:    mode = "FILM2K_1556/14sF";    break;
  case SV_MODE_FILM2K_1556_15sF:    mode = "FILM2K_1556/15sF";    break;
  case SV_MODE_FILM2K_1556_19sF:    mode = "FILM2K_1556/19sF";    break;
  case SV_MODE_FILM2K_1556_20sF:    mode = "FILM2K_1556/20sF";    break;
  case SV_MODE_FILM2K_1556_24sF:    mode = "FILM2K_1556/24sF";    break;
  case SV_MODE_FILM2K_1556_29sF:    mode = "FILM2K_1556/29sF";    break;
  case SV_MODE_FILM2K_1556_30sF:    mode = "FILM2K_1556/30sF";    break;
  case SV_MODE_FILM2K_1556_36sF:    mode = "FILM2K_1556/36sF";    break;

  case SV_MODE_FILM2K_1556_24P:     mode = "FILM2K_1556/24P";     break;
  case SV_MODE_FILM2K_1556_48P:     mode = "FILM2K_1556/48P";     break;

  case SV_MODE_FILM4K_2160_24P:     mode = "FILM4K_2160/24P";     break;

  case SV_MODE_FILM4K_3112_5sF:     mode = "FILM4K_3112/5sF";     break;
  case SV_MODE_FILM4K_3112_24sF:    mode = "FILM4K_3112/24sF";    break;
  case SV_MODE_FILM4K_3112_24P:     mode = "FILM4K_3112/24P";     break;
  ...
  case SV_MODE_VESA_1280x1024_29I:  mode = "VESA_1280x1024/30I";   break;
...
int sv_support_string2videomode(char * string, int offset)
{
  ...
  if(offset) {
    ...
    } else if(!strcmp(tmp[0], "PPAL")) {
      mode = SV_MODE_PPAL;
      next = 1;
    } else if(!strcmp(tmp[0], "PNTSC")) {
      mode = SV_MODE_PNTSC;
      next = 1;
    } else if(!strcmp(tmp[0], "PPALHR")) {
      mode = SV_MODE_PPALHR;
      next = 1;
    } else if(!strcmp(tmp[0], "PNTSCHR")) {
      mode = SV_MODE_PNTSCHR;
      next = 1;
  ...
  for(i = next; (mode != -1) && (i < arraycount); i++) {
    ...
    } else if(!strcmp(tmp[i], "RAW") | !strcmp(tmp[i], "STREAMER")) {
      mode &= ~SV_MODE_ACTIVE_MASK;
      mode |=  SV_MODE_ACTIVE_STREAMER;
    ...
    } else if(!strcmp(tmp[i], "Bayer_RGB")) {
      mode &= ~SV_MODE_COLOR_MASK;
      mode |=  SV_MODE_COLOR_BAYER_RGB;
