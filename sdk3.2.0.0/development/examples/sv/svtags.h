...
/* sv_clib.c        */ int jpeg_disksetup(sv_handle * sv, char * setup, char * colormode, int compression);
...
/* sv_clib.c        */ void jpeg_gamma(sv_handle * sv, int argc, char ** argv);
...
/* sv_clib.c        */ void jpeg_outduringrec(sv_handle * sv, int argc, char ** argv);
/* sv_clib.c        */ void jpeg_outpoint(sv_handle * sv, int outpoint);
/* sv_clib.c        */ void jpeg_outputport(sv_handle * sv, char * what);
/* sv_clib.c        */ void jpeg_overlay(sv_handle * sv, int argc, char ** argv);
