...
#define PCI_DEVICEID_DVS_DIGILAB      0x0050
#define PCI_DEVICEID_DVS_HYDRAX       0x0060
#define PCI_DEVICEID_DVS_ATOMIX       0x0061
#define PCI_DEVICEID_DVS_ATOMIXLT     0x0062
...
#define PS_CARDTYPE_DIGILAB           8
#define PS_CARDTYPE_HYDRAX            9
#define PS_CARDTYPE_COUNT             10
...
typedef struct {
  ...
  int         mdl_pages;        ///< Number of pages in memory description list
...
#define PS_QUEUE_TYPE_CAPTURE           ( 1      <<24)
