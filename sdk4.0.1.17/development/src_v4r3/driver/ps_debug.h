...
#define DPF_ANCMASK_VERBOSE       0x00000010
#define DPF_ANCMASK_AUDIO         0x00000020 

// Audio
#define DPF_AUDIOMASK_1	          0x00000001
#define DPF_AUDIOMASK_DISPLAY     0x00000002
#define DPF_AUDIOMASK_RECORD	  0x00000004
#define DPF_AUDIOMASK_DETECT      0x00000008
#define DPF_AUDIOMASK_OFFSET      0x00000010
#define DPF_AUDIOMASK_CHECK       0x00000020
...
#define DPF_FIFOMASK_VSYNC        0x00000004
#define DPF_FIFOMASK_PREPARE      0x00000008
#define DPF_FIFOMASK_READY        0x00000010
...
#define DPF_JP2KMASK_STATEMACHINE 0x00000020
#define DPF_JP2KMASK_ANY          0xffffffdf
...
#define DPF_IRQMASK_VIDEO_OUTSD   0x00000100
#define DPF_IRQMASK_VIDEO_OUTDVI  0x00000200
#define DPF_IRQMASK_SORT          0x00000400
...
#define DPF_RENDERMASK_SPEED      0x00000010

// Timecode
#define DPF_TCMASK_DVITC_INPUT    0x00000001
#define DPF_TCMASK_DVITC_OUTPUT   0x00000002
#define DPF_TCMASK_LTC_INPUT      0x00000004
#define DPF_TCMASK_LTC_OUTPUT     0x00000008
#define DPF_TCMASK_OPTIONAT       0x00000010
#define DPF_TCMASK_RECORD         0x00000020
#define DPF_TCMASK_VITC_DECODE    0x00000040
#define DPF_TCMASK_VITC_INPUT     0x00000080
#define DPF_TCMASK_VITC_OUTPUT    0x00000100
#define DPF_TCMASK_VTRTC          0x00000200

// Video
#define DPF_VIDEOMASK_VIDEO	  0x00000001
#define DPF_VIDEOMASK_VIDEO2	  0x00000002
#define DPF_VIDEOMASK_VIDEO3      0x00000004
#define DPF_VIDEOMASK_BYPASS      0x00000008
#define DPF_VIDEOMASK_CLOCK       0x00000010
#define DPF_VIDEOMASK_DETECT      0x00000020
#define DPF_VIDEOMASK_DETECTDUMP  0x00000040
#define DPF_VIDEOMASK_FILTER      0x00000080
#define DPF_VIDEOMASK_GENLOCK     0x00000100
#define DPF_VIDEOMASK_MATRIX      0x00000200
#define DPF_VIDEOMASK_DISPLAY     0x00000400
#define DPF_VIDEOMASK_RECORD      0x00000800
#define DPF_VIDEOMASK_SDI         0x00001000
#define DPF_VIDEOMASK_SYNC        0x00002000

// Vtr
#define DPF_VTRMASK_MASTER   	  0x00000001
#define DPF_VTRMASK_MASTER2   	  0x00000002
#define DPF_VTRMASK_MASTER3       0x00000004
#define DPF_VTRMASK_MOVETO        0x00000008
#define DPF_VTRMASK_PACKETS       0x00000010
...
#define DPF_MASK_INPUTDUMP        0x00000020
...
//#define DPF_MASK_UNUSED         0x00001000
#define DPF_MASK_MALLOC	          0x00002000
#define DPF_MASK_OPEN	          0x00004000
//#define DPF_MASK_UNUSED         0x00008000
//#define DPF_MASK_UNUSED         0x00010000
...
#define DPF_MASK_VTRSLAVE_SPEED   0x00800000
#define DPF_MASK_VTRSLAVE_JOG     0x01000000
...
# define DPF_CHECK_VTR(mask)      if(ps_debug_vtr & mask)
...
# define DPF_CHECK_VTR(mask)      if(0)
...
#define DPF_ANC_VERBOSE   DPF_CHECK_ANC(DPF_ANCMASK_VERBOSE)  DPF
#define DPF_ANC_AUDIO     DPF_CHECK_ANC(DPF_ANCMASK_AUDIO)    DPF

// Audio
#define DPF_AUDIO	  DPF_CHECK_AUDIO(DPF_AUDIOMASK_1)        DPF
#define DPF_AUDIO_CHECK   DPF_CHECK_AUDIO(DPF_AUDIOMASK_CHECK)    DPF
#define DPF_AUDIO_DISPLAY DPF_CHECK_AUDIO(DPF_AUDIOMASK_DISPLAY)  DPF
#define DPF_AUDIO_RECORD  DPF_CHECK_AUDIO(DPF_AUDIOMASK_RECORD)   DPF
#define DPF_AUDIO_DETECT  DPF_CHECK_AUDIO(DPF_AUDIOMASK_DETECT)   DPF
#define DPF_AUDIO_OFFSET  DPF_CHECK_AUDIO(DPF_AUDIOMASK_OFFSET)   DPF
#define DPF_AUDIO_ERROR   DPF_CHECK_AUDIO(DPF_MASK_ANY)           DPF
...
#define DPF_FIFO_PREPARE  DPF_CHECK_FIFO(DPF_FIFOMASK_PREPARE)    DPF
#define DPF_FIFO_READY    DPF_CHECK_FIFO(DPF_FIFOMASK_READY)      DPF
#define DPF_FIFO_VSYNC	  DPF_CHECK_FIFO(DPF_FIFOMASK_VSYNC)      DPF
...
#define DPF_IRQ_SORT                DPF_CHECK_IRQ(DPF_IRQMASK_SORT)           DPF
#define DPF_IRQ_TIME                DPF_CHECK_IRQ(DPF_IRQMASK_TIME)           DPF
...
#define DPF_IRQ_VIDEO_OUTSD	    DPF_CHECK_IRQ(DPF_IRQMASK_VIDEO_OUTSD)    DPF
#define DPF_IRQ_VIDEO_OUTDVI        DPF_CHECK_IRQ(DPF_IRQMASK_VIDEO_OUTDVI)   DPF
...
#define DPF_JP2K_STATEMACHINE       DPF_CHECK_JP2K(DPF_JP2KMASK_STATEMACHINE) DPF
...
#define DPF_RENDER_SPEED            DPF_CHECK_RENDER(DPF_RENDERMASK_SPEED)    DPF
...
#define DPF_VIDEO_BYPASS            DPF_CHECK_VIDEO(DPF_VIDEOMASK_BYPASS)     DPF
...
#define DPF_VIDEO_DETECTDUMP        DPF_CHECK_VIDEO(DPF_VIDEOMASK_DETECTDUMP) DPF
#define DPF_VIDEO_DISPLAY           DPF_CHECK_VIDEO(DPF_VIDEOMASK_DISPLAY)    DPF
#define DPF_VIDEO_FILTER            DPF_CHECK_VIDEO(DPF_VIDEOMASK_FILTER)     DPF
#define DPF_VIDEO_GENLOCK           DPF_CHECK_VIDEO(DPF_VIDEOMASK_GENLOCK)    DPF
#define DPF_VIDEO_MATRIX            DPF_CHECK_VIDEO(DPF_VIDEOMASK_MATRIX)     DPF
#define DPF_VIDEO_RECORD            DPF_CHECK_VIDEO(DPF_VIDEOMASK_RECORD)     DPF
#define DPF_VIDEO_SDI               DPF_CHECK_VIDEO(DPF_VIDEOMASK_SDI)        DPF
#define DPF_VIDEO_SYNC              DPF_CHECK_VIDEO(DPF_VIDEOMASK_SYNC)       DPF

// Vtr
#define DPF_MASTER	            DPF_CHECK_VTR(DPF_VTRMASK_MASTER)         DPF
#define DPF_MASTER2	            DPF_CHECK_VTR(DPF_VTRMASK_MASTER2)        DPF
#define DPF_MASTER3	            DPF_CHECK_VTR(DPF_VTRMASK_MASTER3)        DPF
#define DPF_VTR_MOVETO              DPF_CHECK_VTR(DPF_VTRMASK_MOVETO)         DPF
...
#if 0
#define DVSSCOPE_ANY(ps, string, value)       DPF_CHECK_DVSSCOPE(~0)                  dvsscope(ps, string, value)
#define DVSSCOPE_JPEG(ps, string, value)      DPF_CHECK_DVSSCOPE(DPF_DVSSCOPE_JPEG)   dvsscope(ps, string, value)
#define DVSSCOPE_IRQ(ps, string, value)       DPF_CHECK_DVSSCOPE(DPF_DVSSCOPE_IRQ)    dvsscope(ps, string, value)
#define DVSSCOPE_RENDER(ps, string, value)    DPF_CHECK_DVSSCOPE(DPF_DVSSCOPE_RENDER) dvsscope(ps, string, value)
#define DVSSCOPE_DETECT(ps, string, value)    DPF_CHECK_DVSSCOPE(DPF_DVSSCOPE_DETECT) dvsscope(ps, string, value)
#else
#define DVSSCOPE_ANY(ps, string, value)       
#define DVSSCOPE_JPEG(ps, string, value)      
#define DVSSCOPE_IRQ(ps, string, value)       
#define DVSSCOPE_RENDER(ps, string, value)    
#define DVSSCOPE_DETECT(ps, string, value)    
#endif
