...
int dpxio_dpx_opensequence(dpxio_handle * dpxio, char * filename, int firstframe, int lastframe)
{
  return TRUE;
}

int dpxio_dpx_closesequence(dpxio_handle * dpxio)
{
  return TRUE;
}

int dpxio_dpx_readframe(dpxio_handle * dpxio, int framenr, sv_fifo_buffer * pbuffer, char * buffer, int buffersize, int * offset, int * xsize, int * ysize, int * dpxtype, int * nbits, int * lineoffset)
{
...
int dpxio_dpx_writeframe(dpxio_handle * dpxio, int framenr, sv_fifo_buffer * pbuffer, char * buffer, int buffersize, int xsize, int ysize, int dpxtype, int nbits, int offset, int padding, int timecode)
{
  char filename[MAX_PATHNAME];
